...
const MagicButton = ({
  ...
  return (
    <button
      className="relative inline-flex h-12 md:h-14 lg:h-16 2k:h-18 4k:h-20 w-full md:w-60 lg:w-72 2k:w-80 4k:w-96 mt-6 md:mt-10 lg:mt-12 2k:mt-14 4k:mt-16 overflow-hidden rounded-xl p-[1px] focus:outline-none"
      onClick={handleClick}
    >
